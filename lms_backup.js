alert(".........Welcome to the Mini Library Management System..........");
...
switch (option) {
    case 1:
        showAvailableBooks();
        confirm("Do you want to perform another action?") ? showMenu() : process.exit();
        break;
    case 2:
...
function addBook(title, author) {
    ...
    alert(`Book "${title}" by ${author} has been added to the library.`);
}
...
function returnBook(id) {
    ...
    if (book) {
        if (book.borrowed) {
            ...
            alert(`"${book.title}" is not currently borrowed.`);
        }
    } else {
        alert("Book not found.");
    }
